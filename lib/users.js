...
async function createUser({ username, password, role }) {
  ...
  const user = {
    ...
    lastSeen: null,
    // 0.30.0: uuManifestUrl is now the primary config — debrid keys remain
    ...
    config: { uuManifestUrl: '', rd: '', tb: '', pm: '', catalogs: [], autoCache: { rd: false, tb: false, pm: false }, maxStreams: 0 },
  };
