...
function computeDigest(root, paths) {
  ...
  for (const relative of [...paths].sort()) {
    ...
    // Git may materialize text files as CRLF on Windows and LF in Linux
    // containers. Hash the repository content rather than the checkout style,
    // while leaving binary artwork byte-for-byte significant.
