...
function getNewsnab() {
  ...
  return {
    url: str(n.url) || config.newsnab.url || '',
    apiKey: str(n.apiKey) || config.newsnab.apiKey || '',
...
module.exports = { getProwlarr, getZilean, getNewsnab, setSources, getCompanion, setCompanion };
