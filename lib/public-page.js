...
function configurationPage({ config = {}, promotions = [], token = '' } = {}) {
  ...
  <main class="config-wrap">
    ...
    <section class="config-card">
      ...
      <div class="output${token ? ' show' : ''}" id="output"><label>Your private manifest URL</label><div class="output-row"><input class="input" id="manifest-url" readonly><button class="small-btn" id="copy-output" type="button">Copy</button></div><label style="margin-top:12px">Private editing link — store this separately</label><div class="output-row"><input class="input" id="edit-url" readonly><button class="small-btn" id="copy-edit" type="button">Copy</button></div><div style="margin-top:10px"><a id="collection-link" class="fine" href="#">Download Nuvio collection JSON</a></div></div>
  ...
  (function(){
    ...
    document.getElementById('install').addEventListener('click',function(){generate('install');});document.getElementById('copy').addEventListener('click',function(){generate('copy');});document.getElementById('download-collection').addEventListener('click',function(){generate('collection-download');});document.getElementById('copy-collection').addEventListener('click',function(){generate('collection-copy');});document.getElementById('copy-output').addEventListener('click',async function(){await copyText(document.getElementById('manifest-url').value);document.getElementById('message').textContent='Manifest link copied.';});document.getElementById('copy-edit').addEventListener('click',async function(){await copyText(document.getElementById('edit-url').value);document.getElementById('message').textContent='Private editing link copied.';});
