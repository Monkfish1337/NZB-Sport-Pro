...
function configurationPage({ config = {}, promotions = [], token = '' } = {}) {
  ...
  <style>
    .config-wrap{width:min(880px,calc(100% - 28px));margin:0 auto;padding:28px 0 70px}.config-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:26px}.config-head .brand{font-size:24px}.config-head p{margin:3px 0 0;color:var(--muted);font-size:13px}.edit-pill{border:1px solid rgba(255,122,24,.3);background:rgba(255,122,24,.08);color:var(--orange2);border-radius:100px;padding:6px 10px;font-size:11px;font-weight:800}.config-card{background:linear-gradient(160deg,#151619,#101113);border:1px solid var(--line);border-radius:17px;padding:clamp(18px,4vw,30px);box-shadow:0 28px 90px rgba(0,0,0,.35)}.config-card h1{font-size:30px;line-height:1.1;letter-spacing:-.04em;margin:0 0 8px}.intro{color:var(--muted);margin:0 0 26px}.block{border:1px solid var(--line);border-radius:13px;background:rgba(255,255,255,.018);margin:12px 0;overflow:hidden}.block-head{padding:15px 17px;border-bottom:1px solid var(--line);font-weight:800}.block-body{padding:17px}.block p.help{color:var(--muted);font-size:13px;margin:0 0 15px}.secret{display:flex}.secret .input{border-radius:10px 0 0 10px}.reveal{border:1px solid #34353a;border-left:0;background:#1b1c20;color:var(--muted);padding:0 14px;border-radius:0 10px 10px 0;cursor:pointer}.indexer-row{display:grid;grid-template-columns:.8fr 1.45fr 1fr auto;gap:10px;align-items:end;padding:14px 0;border-top:1px solid rgba(255,255,255,.055)}.indexer-row:first-child{border-top:0;padding-top:0}.indexer-row label,.field label{display:block;margin:0 0 6px;font-size:12px;color:#c6c7cb;font-weight:750}.remove{background:transparent;border:0;color:#ff827b;padding:12px 4px;cursor:pointer}.small-btn{border:1px solid #44454a;background:transparent;color:var(--ink);border-radius:8px;padding:8px 11px;cursor:pointer;font-weight:700;font-size:12px}.small-btn.danger-action{border-color:rgba(255,93,93,.38);color:#ffaaa5}.service-actions{display:flex;gap:9px;align-items:center;margin-top:13px}.service-results{display:none;margin-top:12px;border:1px solid var(--line);border-radius:9px;padding:10px 12px;background:rgba(0,0,0,.18);font-size:12px}.service-results.show{display:block}.service-result{display:flex;justify-content:space-between;gap:12px;padding:5px 0}.service-result+.service-result{border-top:1px solid rgba(255,255,255,.05)}.service-ok{color:#70ddb5}.service-fail{color:#ffaaa5}.toggle{display:flex;gap:11px;align-items:flex-start;margin:12px 0}.toggle input,.check input{accent-color:var(--orange)}.toggle b{display:block}.toggle span{display:block;color:var(--muted);font-size:12px}.fold{border:1px solid var(--line);border-radius:13px;margin:12px 0;background:rgba(255,255,255,.018)}.fold summary{cursor:pointer;padding:15px 17px;font-weight:800;list-style:none}.fold summary:after{content:"⌄";float:right;color:var(--muted)}.fold[open] summary{border-bottom:1px solid var(--line)}.fold-body{padding:17px}.catalog-group+ .catalog-group{margin-top:18px}.catalog-group strong{display:block;margin-bottom:8px;color:var(--orange2)}.catalog-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.check{display:flex;gap:8px;align-items:center;border:1px solid rgba(255,255,255,.055);padding:9px 10px;border-radius:8px;color:#c9cacf}.advanced-grid{display:grid;grid-template-columns:minmax(180px,320px);gap:16px}.advanced-toggle{margin:0;grid-column:1/-1;border:1px solid rgba(255,255,255,.055);padding:11px 12px;border-radius:9px}.actions-bar{display:flex;gap:10px;flex-wrap:wrap}.actions-bar.center{justify-content:center;margin-top:22px}.actions-bar .btn{min-width:150px}.save-edits{width:100%;margin-top:18px;padding:15px 18px;font-size:16px}.product-actions{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:12px}.product-action{border:1px solid var(--line);border-radius:12px;padding:15px;background:rgba(0,0,0,.16)}.product-action b{display:block;margin-bottom:4px}.product-action p{color:var(--muted);font-size:12px;margin:0 0 13px}.output{display:none;margin-top:18px;padding:14px;border:1px solid rgba(64,211,156,.25);background:rgba(64,211,156,.06);border-radius:11px}.output.show{display:block}.output label{display:block;color:#8ee8c5;font-size:12px;font-weight:800;margin-bottom:7px}.output-row{display:flex;gap:8px}.output .input{font-size:11px}.edit-link-card{margin-top:14px;padding:15px;border:2px solid rgba(255,122,24,.72);border-radius:11px;background:linear-gradient(135deg,rgba(255,122,24,.16),rgba(255,157,46,.06));box-shadow:0 12px 34px rgba(255,122,24,.1)}.edit-link-card label{color:var(--orange2);font-size:14px}.edit-link-card p{margin:0 0 10px;color:#e2c8b2;font-size:12px}.edit-link-card .small-btn{border-color:var(--orange);color:var(--orange2);font-weight:900}.config-management{display:flex;gap:8px;justify-content:flex-end;margin-top:13px;padding-top:13px;border-top:1px solid rgba(255,255,255,.08)}.message{min-height:20px;text-align:center;color:var(--muted);font-size:13px;margin-top:12px}.danger{color:#ff9a94}.privacy{display:flex;justify-content:center;gap:7px;color:var(--muted);font-size:12px;margin-top:18px}.privacy b{color:#c9cacf}@media(max-width:760px){.indexer-row,.catalog-grid,.advanced-grid,.product-actions{grid-template-columns:1fr}.remove{text-align:left;padding:2px}.config-head{align-items:flex-start}.edit-pill{display:none}}
  </style>
  <main class="config-wrap">
    <header class="config-head"><a class="brand" href="/configure"><span class="mark">N</span><span>NZB-Sport-Pro</span></a><div class="navlinks"><span id="edit-state">${editNote}</span><a class="btn" href="/login">Admin login</a></div></header>
    <section class="config-card">
      ...
      <div class="block"><div class="block-head">Newznab indexers</div><div class="block-body">
        ...
        <div class="service-actions"><button id="add-indexer" class="small-btn" type="button">+ Add indexer</button><button id="test-services" class="small-btn" type="button">Test services</button></div>
        <div class="service-results" id="service-results" aria-live="polite"></div>
      </div></div>
      ...
      <details class="fold"><summary>Advanced settings</summary><div class="fold-body">
        <div class="advanced-grid">
          ...
          <div class="field"><label for="max-result-size">Maximum result size (GB)</label><input class="input" id="max-result-size" type="number" min="0" max="100" step="0.5" value="${escapeHtml(String(config.maxResultSizeGb || 0))}"><small class="fine">0 allows any size. Try 8 GB for faster uncached playback; results without size metadata remain visible.</small></div>
          <label class="toggle advanced-toggle"><input id="exclude-pre-shows" type="checkbox"${config.excludePreShows === true ? ' checked' : ''}><span><b>Exclude prelims and pre-shows</b>Hide prelims, preliminary cards, pre-shows, countdowns, kickoff shows, and Zero Hour releases.</span></label>
        </div>
      </div></details>

      <button class="btn primary config-action save-edits" id="save-edits" type="button">Save edits</button>

      <div class="product-actions">
        <div class="product-action"><b>Stremio addon</b><p>Install the private manifest or copy it into another compatible client.</p><div class="actions-bar"><button class="btn primary config-action" id="install" type="button">Install Stremio</button><button class="btn config-action" id="copy" type="button">Copy Manifest</button></div></div>
        <div class="product-action"><b>NZB-Sport-Pro collection</b><p>Generate the four sports folders using the catalogs selected above.</p><div class="actions-bar"><button class="btn primary config-action" id="download-collection" type="button">Download Collection</button><button class="btn config-action" id="copy-collection" type="button">Copy JSON</button></div></div>
      </div>
      <div class="message" id="message" aria-live="polite"></div>
      <div class="output${token ? ' show' : ''}" id="output"><label>Your private manifest URL</label><div class="output-row"><input class="input" id="manifest-url" readonly><button class="small-btn" id="copy-output" type="button">Copy</button></div><div class="edit-link-card"><label>⚠ Save your private editing link</label><p>This is the only way to reopen and change this configuration after closing this page. Store it somewhere safe; the installed manifest cannot recover it.</p><div class="output-row"><input class="input" id="edit-url" readonly><button class="small-btn" id="copy-edit" type="button">Copy editing link</button></div></div><div style="margin-top:10px"><a id="collection-link" class="fine" href="#">Download Nuvio collection JSON</a></div><div class="config-management"><button class="small-btn" id="rotate-manifest" type="button">Rotate manifest</button><button class="small-btn danger-action" id="delete-config" type="button">Delete configuration</button></div></div>
      <div class="privacy">🔒 <span><b>Separated credentials.</b> The manifest can use your services but cannot reveal their keys. Only the separate editing link can display or change them.</span></div>
    </section>
  </main>
  ...
  (function(){
    ...
    function payload(){return {torboxApiKey:document.getElementById('torbox-key').value.trim(),newznabIndexers:rows().map(function(row){return {name:row.querySelector('.ix-name').value.trim(),url:row.querySelector('.ix-url').value.trim(),apiKey:row.querySelector('.ix-key').value.trim()};}).filter(function(x){return x.url||x.apiKey||x.name;}),catalogs:Array.prototype.slice.call(document.querySelectorAll('.catalog:checked')).map(function(i){return i.value;}),showCatalogsOnHome:document.getElementById('show-home').checked,maxStreams:parseInt(document.getElementById('max-streams').value||'0',10),maxResultSizeGb:parseFloat(document.getElementById('max-result-size').value||'0'),excludePreShows:document.getElementById('exclude-pre-shows').checked};}
    function editToken(){var match=window.location.hash.match(/^#edit=(.+)$/);if(!match)return '';try{return decodeURIComponent(match[1]);}catch(_){return '';}}
    function setIndexerRows(indexers){root.innerHTML='';(indexers&&indexers.length?indexers:[{}]).forEach(function(item){var fragment=template.content.cloneNode(true),row=fragment.querySelector('.indexer-row');row.querySelector('.ix-name').value=item.name||'';row.querySelector('.ix-url').value=item.url||'';row.querySelector('.ix-key').value=item.apiKey||'';root.appendChild(fragment);});sync();}
    function showLinks(data){var origin=window.location.origin,manifest=data.manifestUrl||(origin+'/c/'+encodeURIComponent(data.accessToken)+'/manifest.json');document.getElementById('manifest-url').value=manifest;document.getElementById('edit-url').value=data.editUrl||(origin+window.location.pathname+window.location.hash);document.getElementById('collection-link').href=data.collectionUrl||manifest.replace(/\\/manifest\\.json$/,'/nuvio-collections.json');document.getElementById('output').classList.add('show');}
    function applyConfig(config){document.getElementById('torbox-key').value=config.torboxApiKey||'';setIndexerRows(config.newznabIndexers||[]);var selected=new Set(config.catalogs||[]),all=selected.size===0;document.querySelectorAll('.catalog').forEach(function(input){input.checked=all||selected.has(input.value);});document.getElementById('show-home').checked=config.showCatalogsOnHome!==false;document.getElementById('max-streams').value=config.maxStreams||0;document.getElementById('max-result-size').value=config.maxResultSizeGb||0;document.getElementById('exclude-pre-shows').checked=config.excludePreShows===true;document.getElementById('edit-state').innerHTML='<span class="edit-pill">Editing existing configuration</span>';}
    async function loadEdit(){var token=editToken();if(!token)return;var message=document.getElementById('message');message.textContent='Loading private configuration…';try{var response=await fetch('/configure/edit',{method:'POST',headers:{'Authorization':'Bearer '+token}}),data=await response.json();if(!response.ok)throw new Error(data.error||'Editing link is invalid.');applyConfig(data.config);showLinks(data);message.textContent='Private configuration loaded.';}catch(err){message.className='message danger';message.textContent=err.message;}}
    async function generate(action){var message=document.getElementById('message'),buttons=Array.prototype.slice.call(document.querySelectorAll('.config-action'));buttons.forEach(function(b){b.disabled=true;});message.className='message';message.textContent='Saving encrypted configuration…';try{var headers={'Content-Type':'application/json'},existingEdit=editToken();if(existingEdit)headers.Authorization='Bearer '+existingEdit;var response=await fetch('/configure/token',{method:'POST',headers:headers,body:JSON.stringify(payload())});var data=await response.json();if(!response.ok)throw new Error(data.error||'Configuration failed.');document.getElementById('manifest-url').value=data.manifestUrl;document.getElementById('edit-url').value=data.editUrl;document.getElementById('collection-link').href=data.collectionUrl;document.getElementById('output').classList.add('show');history.replaceState(null,'',data.configureUrl);document.getElementById('edit-state').innerHTML='<span class="edit-pill">Editing existing configuration</span>';if(action==='save'){message.textContent='Changes saved. Save your private editing link below before closing this page.';}else if(action==='copy'){await copyText(data.manifestUrl);message.textContent='Manifest link copied. Remember to save the separate editing link below.';}else if(action==='collection-copy'){var collectionResponse=await fetch(data.collectionUrl);if(!collectionResponse.ok)throw new Error('Collection generation failed.');await copyText(JSON.stringify(await collectionResponse.json(),null,2));message.textContent='Nuvio collection JSON copied. Remember to save the editing link below.';}else if(action==='collection-download'){message.textContent='Downloading Nuvio collection… Save the editing link below before leaving.';window.location.href=data.collectionUrl;}else{message.textContent='Opening Stremio… Save the editing link below before closing this page.';window.location.href=data.installUrl;}}catch(err){message.className='message danger';message.textContent=err.message;}finally{buttons.forEach(function(b){b.disabled=false;});}}
    async function testServices(){var button=document.getElementById('test-services'),box=document.getElementById('service-results');button.disabled=true;box.className='service-results show';box.textContent='Checking TorBox and your indexers…';try{var response=await fetch('/configure/test-services',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(payload())}),data=await response.json();if(!response.ok)throw new Error(data.error||'Service check failed.');var items=[{name:'TorBox',ok:data.torbox.ok,message:data.torbox.message}].concat(data.indexers||[]);box.innerHTML='';items.forEach(function(item){var row=document.createElement('div'),name=document.createElement('b'),detail=document.createElement('span');row.className='service-result';name.textContent=(item.ok?'✓ ':'✕ ')+item.name;name.className=item.ok?'service-ok':'service-fail';detail.textContent=item.message;row.appendChild(name);row.appendChild(detail);box.appendChild(row);});}catch(err){box.textContent=err.message;box.className='service-results show service-fail';}finally{button.disabled=false;}}
    ...
    async function rotateManifest(){var token=editToken(),message=document.getElementById('message');if(!token)return message.textContent='Save the configuration before rotating its manifest.';if(!confirm('Rotate the manifest? The currently installed manifest will stop working immediately.'))return;try{var response=await fetch('/configure/rotate-manifest',{method:'POST',headers:{'Authorization':'Bearer '+token}}),data=await response.json();if(!response.ok)throw new Error(data.error||'Manifest rotation failed.');showLinks(data);message.className='message';message.textContent='Manifest rotated. Copy and reinstall the new manifest.';}catch(err){message.className='message danger';message.textContent=err.message;}}
    async function deleteConfiguration(){var token=editToken(),message=document.getElementById('message');if(!token)return message.textContent='No stored configuration is open.';if(!confirm('Permanently delete this configuration? Its manifest and editing link will stop working.'))return;try{var response=await fetch('/configure/delete',{method:'POST',headers:{'Authorization':'Bearer '+token}}),data=await response.json();if(!response.ok)throw new Error(data.error||'Deletion failed.');history.replaceState(null,'','/configure');window.location.reload();}catch(err){message.className='message danger';message.textContent=err.message;}}
    document.getElementById('test-services').addEventListener('click',testServices);document.getElementById('save-edits').addEventListener('click',function(){generate('save');});document.getElementById('install').addEventListener('click',function(){generate('install');});document.getElementById('copy').addEventListener('click',function(){generate('copy');});document.getElementById('download-collection').addEventListener('click',function(){generate('collection-download');});document.getElementById('copy-collection').addEventListener('click',function(){generate('collection-copy');});document.getElementById('rotate-manifest').addEventListener('click',rotateManifest);document.getElementById('delete-config').addEventListener('click',deleteConfiguration);document.getElementById('copy-output').addEventListener('click',async function(){await copyText(document.getElementById('manifest-url').value);document.getElementById('message').textContent='Manifest link copied.';});document.getElementById('copy-edit').addEventListener('click',async function(){await copyText(document.getElementById('edit-url').value);document.getElementById('message').textContent='Private editing link copied.';});
