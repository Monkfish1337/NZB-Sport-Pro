...
function normaliseInput(input) {
  ...
  return {
    torboxApiKey,
    nativeNewznabDirectLinkEnabled: bool(input.nativeNewznabDirectLinkEnabled),
...
function compact(input) {
  ...
  return {
    ...
    dl: value.nativeNewznabDirectLinkEnabled,
...
function expand(payload) {
  ...
  const value = normaliseInput({
    ...
    nativeNewznabDirectLinkEnabled: payload.dl,
  ...
  return {
    ...
    nativeNewznabDirectLinkEnabled: value.nativeNewznabDirectLinkEnabled,
